...
//  TODO: ¿ eS NECESARIO ESTE ARCHIVO ?, ¿eS ESTE EL LUGAR PARA LOS DETALLES DE CARGA Y CAMIÓN ?
/**
  ...
  return (
    <Container>
      ...
      <View className="flex-1 items-center justify-center bg-slate-900 p-6">
        <Text className="mb-4 text-2xl font-bold text-white">Detalles para: {name}</Text>
